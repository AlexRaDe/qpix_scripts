...
def sample_cal(numTrials, DECIMAL_replen):
    ...
    #notWorking = [2,4,5,7,9,10,11,12,13,14,15] 
    ...
    os.system('poke 0x43c00028 0x00000000') # New bit to only look at deltaT2 during calibration
...
## Run this module -ncd
numTrials = 1
DECIMAL_replen = 17  # THIS DOES NOT set Replenishment: only a marker! 
