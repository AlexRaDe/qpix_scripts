...
for DAC_setting in DAC_settings:
    ...
    all_counts, all_timestamps = sample_n_trials(trials_num, win_width=win_width, win_wait=win_wait, reset_width = reset_width, rst_cal_gap=rst_cal_gap, sampling=True, cal_pulse=True, external_clock=external_clock)
    print()
    for c in range(15, 7, -1):
        fname = f'outputs/ch{c}_calib.txt'
